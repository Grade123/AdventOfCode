with open("Day4/input.txt", "r") as f:
    ...
    for line in lines:
        ...
        if elf1Assignment[0] <= elf2Assignment[0] and elf1Assignment[1] >= elf2Assignment[1]:
            ...
            numberOfOverlaps += 1
        elif elf1Assignment[0] <= elf2Assignment[0] and elf1Assignment[1] >= elf2Assignment[0]:
            numberOfOverlaps += 1
        elif elf1Assignment[0] <= elf2Assignment[1] and elf1Assignment[1] >= elf2Assignment[1]:
            numberOfOverlaps += 1
